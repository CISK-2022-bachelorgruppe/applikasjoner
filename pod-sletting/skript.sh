...
wget https://raw.githubusercontent.com/sonjoh/k8s-bachelor/b8b3beb0b5a6805bc43aa3f92f2dbb3fd31b99b0/k8s-config/sched/sched-deployment.yaml -O $Filnavn_sched 2> /dev/null   # Laster ned sched-deployment
...
do
    ...
    minikube kubectl delete pod $POD_django --force 
    sleep 30
done
...
minikube kubectl cp default/$POD_mysql:$Fil_db "$arbeidsmappe$Filnavn_db"                                # Kopierer csv-filen fra podden til host-maskinen
